...
echo -e "${CYAN}"
echo "################################################################"
echo "#       Start downloading and installing oscamstatus_7.40      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1007/refs/heads/main/enigma2-plugin-extensions-oscamstatus_7.40_all.ipk"
IPK_NAME="enigma2-plugin-extensions-oscamstatus_7.40_all.ipk"
