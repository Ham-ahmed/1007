...
echo -e "${CYAN}"
echo "################################################################"
echo "#  Start downloading and installing bouquetmakerxtream_1.77    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1007/refs/heads/main/enigma2-plugin-extensions-bouquetmakerxtream_1.77.20260626_all.ipk"
IPK_NAME="enigma2-plugin-extensions-bouquetmakerxtream_1.77.20260626_all.ipk"
...
echo "#${BLUE}           ON - MagicPanelGold 10.0            ${PURPLE}#"
